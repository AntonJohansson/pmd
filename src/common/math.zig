...
pub const m4 = extern struct {
    ...
    pub fn modelSetScale(m: m4, s: v3) m4 {
        return m4 {
            .m00 = s.x*m.m00, .m01 = s.y*m.m01, .m02 = s.z*m.m02, .m03 = m.m03,
            .m10 = s.x*m.m10, .m11 = s.y*m.m11, .m12 = s.z*m.m12, .m13 = m.m13,
            .m20 = s.x*m.m20, .m21 = s.y*m.m21, .m22 = s.z*m.m22, .m23 = m.m23,
    ...
    pub fn inverse(m: m4) m4 {
        ...
        const inverse_m = m4 {
            .m00 = s*c00, .m01 = s*c10, .m02 = s*c20, .m03 = s*c30,
            .m10 = s*c01, .m11 = s*c11, .m12 = s*c21, .m13 = s*c31,
            .m20 = s*c02, .m21 = s*c12, .m22 = s*c22, .m23 = s*c32,
            .m30 = s*c03, .m31 = s*c13, .m32 = s*c23, .m33 = s*c33,
        };
    ...
    pub fn model(translation: v3, s: v3) m4 {
        return m4 {
            .m00 = s.x, .m01 = 0,   .m02 = 0,   .m03 = translation.x,
            .m10 = 0,   .m11 = s.y, .m12 = 0,   .m13 = translation.y,
            .m20 = 0,   .m21 = 0,   .m22 = s.z, .m23 = translation.z,
            .m30 = 0,   .m31 = 0,   .m32 = 0,   .m33 = 1,
        };
    }
    ...
    pub fn modelWithRotations(translation: v3, s: v3, angles: v3) m4 {
        ...
        return m4 {
            .m00 = s.x*(cosa*cosb),   .m01 = s.y*(cosa*sinb*sinc-sina*cosc),    .m02 = s.z*(cosa*sinb*cosc+sina*sinc),    .m03 = translation.x,
            .m10 = s.x*(sina*cosb),   .m11 = s.y*(sina*sinb*sinc+cosa*cosc),    .m12 = s.z*(sina*sinb*cosc-cosa*sinc),    .m13 = translation.y,
            .m20 = s.x*(-sinb),       .m21 = s.y*(cosb*sinc),                   .m22 = s.z*(cosb*cosc),                   .m23 = translation.z,
            .m30 = 0,                 .m31 = 0,                                 .m32 = 0,                                 .m33 = 1,
        };
    }
    ...
    pub fn modelFromZDir(translation: v3, s: v3, dir: v3) m4 {
        ...
        return m4 {
            .m00 = s.x*i.x,   .m01 = s.y*j.x,   .m02 = s.z*k.x,   .m03 = translation.x,
            .m10 = s.x*i.y,   .m11 = s.y*j.y,   .m12 = s.z*k.y,   .m13 = translation.y,
            .m20 = s.x*i.z,   .m21 = s.y*j.z,   .m22 = s.z*k.z,   .m23 = translation.z,
            .m30 = 0,         .m31 = 0,         .m32 = 0,         .m33 = 1,
        };
    }
